...
include(ROOT_DIR . "/src/controllers/auth.php");
include(ROOT_DIR . "/src/controllers/utility.php");
            ...
            <div class="flex flex-col gap-4 md:flex-row">
                                    ...
                                    <tr>
                                        <td class="py-4">
                                            <div class="flex items-center">
                                                <img class="object-cover w-16 h-16 mr-4 rounded-sm aspect-square"
                                                    src="<?php $utility->productImage($cartItem['image_path']); ?>"
                                                    alt="Product image">
                                                <span class="font-semibold"><?php echo $cartItem['product_name']; ?></span>

                                            </div>
                                        </td>
                                        <td class="py-4">Rp <?php echo number_format($cartItem['price'], 2, ',', '.'); ?>
                                        </td>
                                        <td class="py-4">
                                            <div class="flex items-center">
                                        ...
                                        <td class="py-4">Rp
                                            <?php echo number_format($cartItem['price'] * $cartItem['cart_quantity'], 2, ',', '.'); ?>
                                        </td>
                ...
                <div class="md:w-1/4">
                    <div class="p-6 bg-white rounded-lg shadow-md">
                        ...
                        <form id="checkoutForm" action="../controllers/checkout.php" method="POST">
                            <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                            <?php foreach ($cartItems as $eachProduct => $cartItem): ?>
                                <input type="hidden" name="products[<?php echo $eachProduct; ?>][product_id]"
                                    value="<?php echo $cartItem['product_id']; ?>">
                                <input type="hidden" name="products[<?php echo $eachProduct; ?>][quantity]"
                                    value="<?php echo $cartItem['cart_quantity']; ?>">
                                <input type="hidden" name="products[<?php echo $eachProduct; ?>][price]"
