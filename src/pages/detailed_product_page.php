            ...
            <div class="grid gap-8 md:grid-cols-2">
                ...
                <div class="space-y-4">
                    <div class="relative overflow-hidden bg-gray-100 rounded-md aspect-square">
                        <img src="<?php $utility->productImage($image_path) ?>" loading="lazy"
                    ...
                    <div>
                        ...
                        <div class="mb-5 md:mb-8">
                            <span class="inline-block text-sm font-normal text-gray-500 md:text-base">Stocks:
                                <?php echo htmlspecialchars($stock_quantity); ?></span>
                        </div>
                        <!-- stock quantity - end -->
                        ...
                        <div class="mb-4">
                            <div class="flex items-end gap-2">
                                <span class="text-xl font-bold text-gray-800 md:text-2xl">Rp
                        ...
                        <div class="flex gap-2.5">
                            <a onclick="addToCart(<?php echo htmlspecialchars($product_id); ?>)"
