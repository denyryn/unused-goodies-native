...
<body class="font-rubik">
    ...
    <div class="md:px-8">
        ...
        <div
            class="flex flex-col grid-cols-2 p-3 m-2 mb-0 text-sm text-center border md:flex-row md:items-center md:text-left md:justify-between">
            ...
            if ($orderDetails[0]['payment'] == null && $orderDetails[0]['status'] !== 'rejected' && $orderDetails[0]['status'] !== 'accepted') {
                ...
                <!-- upload bukti bayar -->
                <form action="../controllers/store_payment.php" method="post" enctype="multipart/form-data">
        ...
        foreach ($orderDetails as $orderDetail):
            ...
            <div class="flex flex-col p-3 m-2 my-0 border border-t-0 ">
                <div class="relative h-[150px] sm:h-[300px]">
                    <img src="<?php $utility->productImage($orderDetail['image_path']); ?>"
